...
export default function FileUploadField({ check, candidateId, token, onSaved }: { check: VerificationCheck; candidateId: string; token: string | null; onSaved: (check: VerificationCheck) => void }) {
