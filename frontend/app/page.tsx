...
// A quiet horizontal rule used between major sections instead of a color band —
// keeps the page reading as one continuous surface.
function SectionDivider() {
  return <div className="max-w-6xl mx-auto w-full px-6"><div className="h-px bg-[var(--border)]" /></div>;
}
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--background)] text-[var(--foreground)]">
      ...
      <main className="flex-1">
          ...
          <div className="relative max-w-6xl mx-auto w-full px-6 pt-20 pb-16">
            <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-14 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full border border-[var(--border)] bg-[var(--surface)] text-[11px] font-medium px-3 py-1.5 mb-5" style={{ color: PALETTE[4] }}>
                  <Award size={12} />
                  {SERVICES.length}+ verification checks · {INDUSTRIES.length} industries served
                </span>

                <h1
                  className="text-[42px] sm:text-[60px] font-bold tracking-tight leading-[1.04] text-[var(--foreground)]"
                ...
                <p className="text-[16px] text-[var(--muted)] mt-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
        ...
        <section id="verifications" className="max-w-6xl mx-auto w-full px-6 py-20 scroll-mt-20">
        ...
        {/* ================= DASHBOARD PREVIEW ================= */}
        <section id="dashboard" className="max-w-6xl mx-auto w-full px-6 py-20 scroll-mt-20">
        ...
        {/* ================= SECURITY ================= */}
        <section id="security" className="max-w-6xl mx-auto w-full px-6 py-20 scroll-mt-20">
          <div className="text-center mb-10">
        ...
        {/* ================= INDUSTRIES ================= */}
        <section id="industries" className="max-w-6xl mx-auto w-full px-6 py-20 scroll-mt-20">
